        ...
        <div class="col-lg-9">
            ...
            <div class="row">
                ...
                <c:forEach var="app" items="${item}">
                    ...
                    <c:if test='${category=="tablets" && app.getCategory() == AppCategory.TABLETS && !check}'>
                    ...
                    <c:if test="${category=='syrups' && app.getCategory() == AppCategory.SYRUPS && !check}">
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                <a href="individualPage.html?id=${app.getId()}"><img class="card-img-top"
                                                                                     src="${app.getLogo()}"
                    ...
                    <c:if test="${category=='injection' && app.getCategory() == AppCategory.INJECTION && !check}">
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                <a href="individualPage.html?id=${app.getId()}"><img class="card-img-top"
                                                                                     src="${app.getLogo()}"
